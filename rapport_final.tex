...
\section{Livrables}
\begin{itemize}
  \item Notebook principal: \texttt{projet\_bigdata\_extrusion.ipynb}
  \item Rapport LaTeX: \texttt{rapport\_final.tex}
  \item Donnees brutes: \texttt{extrusion.csv}, \texttt{legend.xlsx}, \texttt{stat.csv}
\end{itemize}
